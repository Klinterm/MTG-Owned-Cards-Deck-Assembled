...
class MoxfieldAnalyzerApp:
    ...
    def setup_results_tab(self):
        ...
        # Add labels for the mana columns with colored backgrounds
        # Label spacer to align with columns
        tk.Label(legend_frame, text="", width=28, bg="#f0f0f0").pack(side="left")

        # White Mana
        white_frame = tk.Frame(legend_frame, bg="white", width=25, height=25)
        white_frame.pack(side="left", padx=2)
        tk.Label(white_frame, text="W", bg="white", fg="black").pack(fill="both", expand=True)
        ...
        self.results_tree.heading("Synergy Score", text="Synergy Score",
                                  command=lambda: self.sort_treeview("Synergy Score"))
        ...
        results_scroll_y = ttk.Scrollbar(tree_container, orient="vertical", command=self.results_tree.yview)
        results_scroll_x = ttk.Scrollbar(tree_container, orient="horizontal", command=self.results_tree.xview)
